---
title: Specification
description: The complete format specification for Open Agent Skills.
order: 3
---

# Specification

The complete format specification for Open Agent Skills.

This document defines the Open Agent Skills format.
...
- Clients can use this to store additional properties not defined by the Open Agent Skills spec
