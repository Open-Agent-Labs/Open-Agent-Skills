...
description: Open Agent Skills are a lightweight, open format for extending AI agent capabilities with specialized knowledge and workflows.
order: 2
---

# What are skills?

Open Agent Skills are a lightweight, open format for extending AI agent capabilities with specialized knowledge and workflows.
...
- [View the specification](/docs/specification) to understand the full format.
- [Add skills support to your agent](/docs/integrate-skills) to build a compatible client.
