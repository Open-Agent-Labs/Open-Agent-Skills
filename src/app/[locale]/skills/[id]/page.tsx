          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 md:p-8 mb-6">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-zinc-900 text-white rounded-lg font-medium hover:bg-zinc-800 transition-colors dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 text-sm"
              >
            ...
            {/* Meta Info */}
            <div className="flex flex-wrap items-center gap-4 mt-6 pt-6 border-t border-zinc-100 dark:border-zinc-800">
              <Link
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 md:p-8 mb-6">
            ...
            <div className="bg-zinc-950 rounded-xl p-4 overflow-x-auto">
              <pre className="text-sm text-zinc-300">
                <code>{`# Clone the skill repository
git clone ${skill.repository}

# Or add to your agent's skills directory
cp -r ${skill.id} ~/.config/claude/skills/`}</code>
              </pre>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-5">
              ...
              <div className="text-zinc-900 dark:text-white font-medium">
                {skill.tags?.length || 0} {isZh ? "个标签" : "tags"}
              </div>
            </div>
          </div>
