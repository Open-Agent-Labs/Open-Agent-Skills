...
import { SkillSidebarActions } from "@/components/SkillSidebarActions";
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6 md:p-8 mb-8">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex flex-col gap-3 md:flex-shrink-0 md:w-48">
                <Link
                  href={skill.repository}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-zinc-900 text-white rounded-lg font-medium hover:bg-zinc-800 transition-colors dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-100 text-sm"
                >
