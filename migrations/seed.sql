-- Generated seed data from src/data/skills.ts
-- Run with: npx wrangler d1 execute open-agent-skills-db --local --file=migrations/seed.sql

INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('docx', 'DOCX', 'Create, edit, analyze Word docs with tracked changes, comments, and formatting.', '创建、编辑并分析 Word 文档，支持修订、评论和格式。', '## What is DOCX?
...
A: No, the skill uses open-source libraries to process documents without requiring Word installation.', '## 什么是 DOCX？
...
A: 不需要，该技能使用开源库处理文档，无需安装 Word。', 'document-processing', 'https://github.com/anthropics/skills/tree/main/skills/docx', 'anthropics', 1, 1);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('docx', 'document');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('docx', 'word');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('docx', 'office');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('pdf', 'PDF', 'Extract text, tables, metadata, merge & annotate PDFs.', '提取文本、表格与元数据，并支持合并和批注 PDF。', '## What is PDF?
...
A: Basic layout is preserved. Complex multi-column layouts may require additional processing.', '## 什么是 PDF？
...
A: 基本布局会保留。复杂的多栏布局可能需要额外处理。', 'document-processing', 'https://github.com/anthropics/skills/tree/main/skills/pdf', 'anthropics', 1, 1);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pdf', 'document');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pdf', 'pdf');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pdf', 'extract');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('pptx', 'PPTX', 'Read, generate, and adjust slides, layouts, and templates.', '读取、生成并调整幻灯片、版式与模板。', '## What is PPTX?
...
A: Yes, the skill can read and modify embedded charts, though complex chart editing may require additional configuration.', '## 什么是 PPTX？
...
A: 可以，该技能可以读取和修改嵌入的图表，但复杂图表编辑可能需要额外配置。', 'document-processing', 'https://github.com/anthropics/skills/tree/main/skills/pptx', 'anthropics', 0, 1);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pptx', 'document');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pptx', 'powerpoint');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pptx', 'slides');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('xlsx', 'XLSX', 'Spreadsheet manipulation: formulas, charts, data transformations.', '电子表格处理：公式、图表与数据转换。', '## What is XLSX?
...
A: The skill can process large spreadsheets, but extremely large files may require streaming approaches for optimal performance.', '## 什么是 XLSX？
...
A: 该技能可以处理大型电子表格，但超大文件可能需要流式处理以获得最佳性能。', 'document-processing', 'https://github.com/anthropics/skills/tree/main/skills/xlsx', 'anthropics', 0, 1);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('xlsx', 'document');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('xlsx', 'excel');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('xlsx', 'spreadsheet');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('markdown-to-epub', 'Markdown to EPUB Converter', 'Converts markdown documents and chat summaries into professional EPUB ebook files.', '将 Markdown 文档和聊天摘要转换为专业的 EPUB 电子书。', '## What is Markdown to EPUB Converter?
...
A: Standard Markdown plus common extensions like tables, task lists, and fenced code blocks.', '## 什么是 Markdown 转 EPUB 转换器？
...
A: 支持标准 Markdown 以及表格、任务列表和围栏代码块等常见扩展。', 'document-processing', 'https://github.com/smerchek/claude-epub-skill', 'smerchek', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('markdown-to-epub', 'markdown');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('markdown-to-epub', 'epub');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('markdown-to-epub', 'ebook');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('artifacts-builder', 'Artifacts Builder', 'Suite of tools for creating elaborate, multi-component HTML artifacts using React, Tailwind CSS, and shadcn/ui.', '使用 React、Tailwind CSS 和 shadcn/ui 创建复杂多组件 HTML 作品的工具套件。', '## What is Artifacts Builder?
...
A: They''re suitable for prototypes and demos. Production use may require additional optimization.', '## 什么是 Artifacts Builder？
...
A: 适合原型和演示。生产使用可能需要额外优化。', 'development', 'https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder', 'anthropics', 1, 1);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('artifacts-builder', 'react');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('artifacts-builder', 'tailwind');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('artifacts-builder', 'frontend');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('aws-skills', 'AWS Skills', 'AWS development with CDK best practices, cost optimization MCP servers, and serverless/event-driven architecture patterns.', '涵盖 CDK 最佳实践、成本优化 MCP 服务器与无服务器/事件驱动架构的 AWS 开发。', '## What is AWS Skills?
...
A: Yes, it includes patterns for multi-region and disaster recovery setups.', '## 什么是 AWS Skills？
...
A: 可以，包含多区域和灾难恢复设置的模式。', 'development', 'https://github.com/zxkane/aws-skills', 'zxkane', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('aws-skills', 'aws');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('aws-skills', 'cdk');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('aws-skills', 'serverless');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('changelog-generator', 'Changelog Generator', 'Automatically creates user-facing changelogs from git commits by analyzing history and transforming technical commits into customer-friendly release notes.', '通过分析提交历史自动生成面向用户的变更日志，将技术提交转化为友好的发布说明。', '## What is Changelog Generator?
...
A: The output can be customized, but generation logic is English-focused.', '## 什么是 Changelog Generator？
...
A: 输出可以定制，但生成逻辑以英文为主。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/changelog-generator', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('changelog-generator', 'git');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('changelog-generator', 'changelog');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('changelog-generator', 'automation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('claude-code-terminal-title', 'Claude Code Terminal Title', 'Gives each Claude Code terminal window a dynamic title that describes the work being done.', '为每个 Claude Code 终端窗口设置动态标题，描述当前工作内容。', '## What is Claude Code Terminal Title?
...
A: Minimal impact - title updates are lightweight operations.', '## 什么是 Claude Code Terminal Title？
...
A: 影响最小 - 标题更新是轻量级操作。', 'development', 'https://github.com/bluzername/claude-code-terminal-title', 'bluzername', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('claude-code-terminal-title', 'terminal');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('claude-code-terminal-title', 'productivity');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('claude-code-terminal-title', 'claude-code');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('d3-visualization', 'D3.js Visualization', 'Teaches Claude to produce D3 charts and interactive data visualizations.', '教 Claude 生成 D3 图表与交互式数据可视化。', '## What is D3.js Visualization?
...
A: No, describe what you want and the skill handles the D3 implementation.', '## 什么是 D3.js Visualization？
...
A: 不需要，描述你想要的，技能会处理 D3 实现。', 'development', 'https://github.com/chrisvoncsefalvay/claude-d3js-skill', 'chrisvoncsefalvay', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('d3-visualization', 'd3');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('d3-visualization', 'visualization');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('d3-visualization', 'charts');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('ffuf-web-fuzzing', 'FFUF Web Fuzzing', 'Integrates the ffuf web fuzzer so Claude can run fuzzing tasks and analyze results for vulnerabilities.', '集成 ffuf Web 模糊测试器，让 Claude 执行 fuzzing 并分析漏洞结果。', '## What is FFUF Web Fuzzing?
...
A: Results can be output in JSON, CSV, or human-readable formats.', '## 什么是 FFUF Web Fuzzing？
...
A: 结果可以输出为 JSON、CSV 或人类可读格式。', 'development', 'https://github.com/jthack/ffuf_claude_skill', 'jthack', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ffuf-web-fuzzing', 'security');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ffuf-web-fuzzing', 'fuzzing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ffuf-web-fuzzing', 'testing');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('finishing-dev-branch', 'Finishing Development Branch', 'Guides completion of development work by presenting clear options and handling chosen workflow.', '通过给出清晰选项并执行所选流程，指导完成开发工作。', '## What is Finishing Development Branch?
...
A: Push behavior can be configured - it will ask for confirmation by default.', '## 什么是 Finishing Development Branch？
...
A: 推送行为可配置 - 默认会请求确认。', 'development', 'https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch', 'obra', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('finishing-dev-branch', 'git');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('finishing-dev-branch', 'workflow');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('finishing-dev-branch', 'development');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('ios-simulator', 'iOS Simulator', 'Enables Claude to interact with iOS Simulator for testing and debugging iOS applications.', '让 Claude 与 iOS 模拟器交互，用于测试与调试 iOS 应用。', '## What is iOS Simulator?
...
A: This skill focuses on the simulator. Physical device testing requires different tooling.', '## 什么是 iOS Simulator？
...
A: 该技能专注于模拟器。物理设备测试需要不同的工具。', 'development', 'https://github.com/conorluddy/ios-simulator-skill', 'conorluddy', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ios-simulator', 'ios');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ios-simulator', 'simulator');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ios-simulator', 'mobile');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('langsmith-fetch', 'LangSmith Fetch', 'Debug LangChain and LangGraph agents by automatically fetching and analyzing execution traces from LangSmith Studio.', '通过自动获取并分析 LangSmith Studio 执行轨迹来调试 LangChain 与 LangGraph 代理。', '## What is LangSmith Fetch?
...
A: Standard LangSmith trace formats including runs, spans, and feedback.', '## 什么是 LangSmith Fetch？
...
A: 标准 LangSmith 轨迹格式，包括运行、跨度和反馈。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/langsmith-fetch', 'OthmanAdi', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('langsmith-fetch', 'langchain');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('langsmith-fetch', 'debugging');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('langsmith-fetch', 'observability');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('mcp-builder', 'MCP Builder', 'Guides creation of high-quality MCP (Model Context Protocol) servers for integrating external APIs and services with LLMs.', '指导创建高质量 MCP（模型上下文协议）服务器，用于与外部 API 和服务集成。', '## What is MCP Builder?
...
A: It generates solid foundations that may need customization for production use.', '## 什么是 MCP Builder？
...
A: 它生成坚实的基础，可能需要针对生产使用进行定制。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/mcp-builder', 'ComposioHQ', 1, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('mcp-builder', 'mcp');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('mcp-builder', 'api');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('mcp-builder', 'integration');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('move-code-quality', 'Move Code Quality', 'Analyzes Move language packages against the official Move Book Code Quality Checklist for Move 2024 Edition compliance.', '依据 Move 2024 版官方代码质量清单分析 Move 语言包的合规性。', '## What is Move Code Quality?
...
A: It identifies issues and suggests fixes but doesn''t automatically modify code.', '## 什么是 Move Code Quality？
...
A: 它识别问题并建议修复，但不会自动修改代码。', 'development', 'https://github.com/1NickPappas/move-code-quality-skill', '1NickPappas', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('move-code-quality', 'move');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('move-code-quality', 'blockchain');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('move-code-quality', 'quality');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('playwright-automation', 'Playwright Browser Automation', 'Model-invoked Playwright automation for testing and validating web applications.', '模型触发的 Playwright 自动化，用于测试与验证 Web 应用。', '## What is Playwright Browser Automation?
...
A: Yes, Playwright handles JavaScript-rendered content and waits for elements automatically.', '## 什么是 Playwright Browser Automation？
...
A: 是的，Playwright 处理 JavaScript 渲染的内容并自动等待元素。', 'development', 'https://github.com/lackeyjb/playwright-skill', 'lackeyjb', 1, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('playwright-automation', 'playwright');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('playwright-automation', 'testing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('playwright-automation', 'automation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('prompt-engineering', 'Prompt Engineering', 'Teaches well-known prompt engineering techniques and patterns, including Anthropic best practices and agent persuasion principles.', '介绍经典提示词工程方法与模式，包括 Anthropic 最佳实践和代理说服原则。', '## What is Prompt Engineering?
...
A: Yes, it can analyze prompts and suggest improvements.', '## 什么是 Prompt Engineering？
...
A: 可以，它可以分析提示并建议改进。', 'development', 'https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/customaize-agent/skills/prompt-engineering', 'NeoLabHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('prompt-engineering', 'prompts');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('prompt-engineering', 'ai');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('prompt-engineering', 'best-practices');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('pypict-testing', 'PyPICT Testing', 'Design comprehensive test cases using PICT (Pairwise Independent Combinatorial Testing) for requirements or code.', '使用 PICT（成对独立组合测试）为需求或代码设计全面测试用例。', '## What is PyPICT Testing?
...
A: It generates test cases that can be used with any framework.', '## 什么是 PyPICT Testing？
...
A: 它生成的测试用例可与任何框架配合使用。', 'development', 'https://github.com/omkamal/pypict-claude-skill', 'omkamal', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pypict-testing', 'testing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pypict-testing', 'pict');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('pypict-testing', 'quality');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('reddit-fetch', 'Reddit Fetch', 'Fetches Reddit content via Gemini CLI when WebFetch is blocked or returns 403 errors.', '在 WebFetch 被阻止或返回 403 时，通过 Gemini CLI 获取 Reddit 内容。', '## What is Reddit Fetch?
...
A: Public posts, comments, and subreddit information. Private/restricted content is not accessible.', '## 什么是 Reddit Fetch？
...
A: 公开帖子、评论和子版块信息。私密/受限内容无法访问。', 'development', 'https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch', 'ykdojo', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('reddit-fetch', 'reddit');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('reddit-fetch', 'fetch');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('reddit-fetch', 'api');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('skill-creator', 'Skill Creator', 'Provides guidance for creating effective Claude Skills that extend capabilities with specialized knowledge and workflows.', '指导创建有效的 Claude Skills，以专门知识与流程扩展能力。', '## What is Skill Creator?
...
A: Skills are independent but can be designed to complement each other.', '## 什么是 Skill Creator？
...
A: 技能是独立的，但可以设计成相互补充。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/skill-creator', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-creator', 'skills');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-creator', 'meta');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-creator', 'creation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('skill-seekers', 'Skill Seekers', 'Automatically converts any documentation website into a Claude AI skill in minutes.', '在数分钟内将任意文档网站自动转换为 Claude AI Skill。', '## What is Skill Seekers?
...
A: Results are good starting points but may need refinement for production use.', '## 什么是 Skill Seekers？
...
A: 结果是很好的起点，但可能需要为生产使用进行完善。', 'development', 'https://github.com/yusufkaraaslan/Skill_Seekers', 'yusufkaraaslan', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-seekers', 'documentation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-seekers', 'automation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('skill-seekers', 'conversion');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('software-architecture', 'Software Architecture', 'Implements design patterns including Clean Architecture, SOLID principles, and comprehensive software design best practices.', '实现包括整洁架构、SOLID 原则在内的软件设计模式与最佳实践。', '## What is Software Architecture?
...
A: Yes, it covers patterns applicable to microservices and distributed systems.', '## 什么是 Software Architecture？
...
A: 有，涵盖适用于微服务和分布式系统的模式。', 'development', 'https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/ddd/skills/software-architecture', 'NeoLabHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('software-architecture', 'architecture');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('software-architecture', 'design-patterns');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('software-architecture', 'solid');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('subagent-development', 'Subagent Driven Development', 'Dispatches independent subagents for individual tasks with code review checkpoints between iterations.', '为单个任务分派独立子代理，并在迭代间加入代码审查检查点。', '## What is Subagent Driven Development?
...
A: Yes, review criteria and frequency can be configured.', '## 什么是 Subagent Driven Development？
...
A: 可以，审查标准和频率可以配置。', 'development', 'https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/sadd/skills/subagent-driven-development', 'NeoLabHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('subagent-development', 'agents');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('subagent-development', 'development');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('subagent-development', 'workflow');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('tdd', 'Test Driven Development', 'Use when implementing any feature or bugfix, before writing implementation code.', '在实现任何功能或修复之前使用，再编写实现代码。', '## What is Test Driven Development?
...
A: It can guide adding tests to legacy code incrementally.', '## 什么是 Test Driven Development？
...
A: 它可以指导逐步为遗留代码添加测试。', 'development', 'https://github.com/obra/superpowers/tree/main/skills/test-driven-development', 'obra', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tdd', 'tdd');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tdd', 'testing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tdd', 'development');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('git-worktrees', 'Using Git Worktrees', 'Creates isolated git worktrees with smart directory selection and safety verification.', '创建隔离的 git worktree，并提供智能目录选择与安全校验。', '## What is Using Git Worktrees?
...
A: Yes, the skill handles proper cleanup to avoid orphaned worktrees.', '## 什么是 Using Git Worktrees？
...
A: 可以，该技能处理正确的清理以避免孤立的 worktree。', 'development', 'https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/', 'obra', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-worktrees', 'git');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-worktrees', 'worktrees');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-worktrees', 'workflow');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('connect-apps', 'Connect Apps', 'Connect Claude to any app. Send emails, create issues, post messages across Gmail, Slack, GitHub, Notion, and 1000+ services.', '将 Claude 连接到任意应用，可在 Gmail、Slack、GitHub、Notion 等 1000+ 服务中发送邮件、创建问题、发布消息。', '## What is Connect Apps?
...
A: Yes, the framework supports adding new service integrations.', '## 什么是 Connect Apps？
...
A: 可以，该框架支持添加新的服务集成。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/connect', 'ComposioHQ', 1, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('connect-apps', 'integration');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('connect-apps', 'apps');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('connect-apps', 'automation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('webapp-testing', 'Webapp Testing', 'Tests local web applications using Playwright for verifying frontend functionality, debugging UI behavior, and capturing screenshots.', '使用 Playwright 测试本地 Web 应用，用于验证前端功能、调试界面行为并截图。', '## What is Webapp Testing?
...
A: Screenshots can be compared manually or with visual diff tools.', '## 什么是 Webapp Testing？
...
A: 截图可以手动比较或使用视觉差异工具比较。', 'development', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/webapp-testing', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('webapp-testing', 'playwright');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('webapp-testing', 'testing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('webapp-testing', 'web');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('csv-summarizer', 'CSV Data Summarizer', 'Automatically analyzes CSV files and generates comprehensive insights with visualizations without requiring user prompts.', '自动分析 CSV 文件并生成包含可视化的全面洞察，无需用户提示。', '## What is CSV Data Summarizer?
...
A: Yes, it identifies and reports data quality issues as part of the analysis.', '## 什么是 CSV Data Summarizer？
...
A: 可以，它会识别并报告数据质量问题作为分析的一部分。', 'data-analysis', 'https://github.com/coffeefuelbump/csv-data-summarizer-claude-skill', 'coffeefuelbump', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('csv-summarizer', 'csv');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('csv-summarizer', 'analysis');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('csv-summarizer', 'visualization');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('postgres', 'PostgreSQL', 'Execute safe read-only SQL queries against PostgreSQL databases with multi-connection support and defense-in-depth security.', '在 PostgreSQL 上执行安全只读查询，支持多连接与纵深防御安全策略。', '## What is PostgreSQL?
...
A: This skill focuses on PostgreSQL. Similar skills exist for other databases.', '## 什么是 PostgreSQL？
...
A: 该技能专注于 PostgreSQL。其他数据库有类似的技能。', 'data-analysis', 'https://github.com/sanjay3290/ai-skills/tree/main/skills/postgres', 'sanjay3290', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('postgres', 'postgres');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('postgres', 'sql');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('postgres', 'database');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('brand-guidelines', 'Brand Guidelines', 'Applies Anthropic''s official brand colors and typography to artifacts for consistent visual identity.', '将 Anthropic 官方品牌配色与字体应用于作品，确保视觉一致性。', '## What is Brand Guidelines?
...
A: HTML artifacts, presentations, and documents can all be branded.', '## 什么是 Brand Guidelines？
...
A: HTML 作品、演示文稿和文档都可以品牌化。', 'business-marketing', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/brand-guidelines', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brand-guidelines', 'branding');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brand-guidelines', 'design');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brand-guidelines', 'identity');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('competitive-ads', 'Competitive Ads Extractor', 'Extracts and analyzes competitors'' ads from ad libraries to understand messaging and creative approaches.', '从广告库提取并分析竞品广告，以理解其传播信息与创意方式。', '## What is Competitive Ads Extractor?
...
A: Fetches current active ads. Historical data depends on library availability.', '## 什么是 Competitive Ads Extractor？
...
A: 获取当前活跃的广告。历史数据取决于广告库的可用性。', 'business-marketing', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/competitive-ads-extractor', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('competitive-ads', 'marketing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('competitive-ads', 'ads');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('competitive-ads', 'competitive');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('domain-brainstormer', 'Domain Name Brainstormer', 'Generates creative domain name ideas and checks availability across multiple TLDs including .com, .io, .dev, and .ai.', '生成创意域名并检查 .com、.io、.dev、.ai 等多种后缀的可用性。', '## What is Domain Name Brainstormer?
...
A: Domain availability doesn''t guarantee trademark clearance. Conduct proper trademark research.', '## 什么是 Domain Name Brainstormer？
...
A: 域名可用性不保证商标清除。请进行适当的商标研究。', 'business-marketing', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/domain-name-brainstormer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('domain-brainstormer', 'domain');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('domain-brainstormer', 'naming');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('domain-brainstormer', 'startup');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('internal-comms', 'Internal Comms', 'Helps write internal communications including updates, company newsletters, FAQs, status reports, and project updates.', '协助撰写内部沟通材料，包括更新、公司简报、FAQ、状态报告与项目更新。', '## What is Internal Comms?
...
A: Email, document, and presentation formats for internal distribution.', '## 什么是 Internal Comms？
...
A: 用于内部分发的邮件、文档和演示文稿格式。', 'business-marketing', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/internal-comms', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('internal-comms', 'communication');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('internal-comms', 'writing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('internal-comms', 'business');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('lead-research', 'Lead Research Assistant', 'Identifies and qualifies high-quality leads by analyzing your product, searching for target companies, and providing outreach strategies.', '通过分析你的产品、搜索目标公司并提供触达策略来识别并筛选高质量潜在客户。', '## What is Lead Research Assistant?
...
A: Uses publicly available business information. Ensure your outreach complies with local regulations.', '## 什么是 Lead Research Assistant？
...
A: 使用公开可用的商业信息。请确保你的触达符合当地法规。', 'business-marketing', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/lead-research-assistant', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('lead-research', 'sales');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('lead-research', 'leads');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('lead-research', 'research');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('article-extractor', 'Article Extractor', 'Extract full article text and metadata from web pages.', '从网页中提取完整文章正文与元数据。', '## What is Article Extractor?
...
A: Focuses on text content. Image URLs can be captured but not the images themselves.', '## 什么是 Article Extractor？
...
A: 专注于文本内容。可以捕获图片 URL，但不能提取图片本身。', 'communication', 'https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/article-extractor', 'michalparkola', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('article-extractor', 'web');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('article-extractor', 'extraction');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('article-extractor', 'articles');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('brainstorming', 'Brainstorming', 'Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.', '通过结构化提问与备选探索，将粗略想法转化为完整设计。', '## What is Brainstorming?
...
A: Sessions are interactive and can be as brief or extensive as needed.', '## 什么是 Brainstorming？
...
A: 会议是互动的，可以根据需要简短或深入。', 'communication', 'https://github.com/obra/superpowers/tree/main/skills/brainstorming', 'obra', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brainstorming', 'ideation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brainstorming', 'creativity');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('brainstorming', 'design');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('content-research-writer', 'Content Research Writer', 'Assists in writing high-quality content by conducting research, adding citations, improving hooks, and providing feedback.', '通过研究、补充引用、优化开头并提供反馈，协助产出高质量内容。', '## What is Content Research Writer?
...
A: Yes, provide style guidelines and it will adapt the content accordingly.', '## 什么是 Content Research Writer？
...
A: 可以，提供风格指南，它会相应地调整内容。', 'communication', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/content-research-writer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('content-research-writer', 'writing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('content-research-writer', 'research');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('content-research-writer', 'content');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('family-history', 'Family History Research', 'Provides assistance with planning family history and genealogy research projects.', '协助规划家族史与族谱研究项目。', '## What is Family History Research?
...
A: Yes, it can provide guidance for researching records in various languages and regions.', '## 什么是 Family History Research？
...
A: 可以，它可以为研究各种语言和地区的记录提供指导。', 'communication', 'https://github.com/emaynard/claude-family-history-research-skill', 'emaynard', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('family-history', 'genealogy');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('family-history', 'research');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('family-history', 'history');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('meeting-insights', 'Meeting Insights Analyzer', 'Analyzes meeting transcripts to uncover behavioral patterns including conflict avoidance, speaking ratios, and leadership style.', '分析会议记录以揭示行为模式，包括回避冲突、发言比例和领导风格。', '## What is Meeting Insights Analyzer?
...
A: Yes, providing multiple transcripts enables trend analysis over time.', '## 什么是 Meeting Insights Analyzer？
...
A: 可以，提供多个记录可以进行长期趋势分析。', 'communication', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/meeting-insights-analyzer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('meeting-insights', 'meetings');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('meeting-insights', 'analysis');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('meeting-insights', 'insights');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('notebooklm', 'NotebookLM Integration', 'Lets Claude Code chat directly with NotebookLM for source-grounded answers based exclusively on uploaded documents.', '让 Claude Code 直接与 NotebookLM 对话，基于上传文档提供有据可依的回答。', '## What is NotebookLM Integration?
...
A: No, answers are grounded only in documents you''ve uploaded to NotebookLM.', '## 什么是 NotebookLM Integration？
...
A: 不能，答案仅基于你上传到 NotebookLM 的文档。', 'communication', 'https://github.com/PleasePrompto/notebooklm-skill', 'PleasePrompto', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('notebooklm', 'notebooklm');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('notebooklm', 'research');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('notebooklm', 'documents');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('canvas-design', 'Canvas Design', 'Creates beautiful visual art in PNG and PDF documents using design philosophy and aesthetic principles.', '运用设计哲学与美学原则在 PNG 与 PDF 中创作精美视觉艺术。', '## What is Canvas Design?
...
A: PDF output includes vector elements. Pure SVG export may require additional tools.', '## 什么是 Canvas Design？
...
A: PDF 输出包含矢量元素。纯 SVG 导出可能需要额外工具。', 'creative-media', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/canvas-design', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('canvas-design', 'design');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('canvas-design', 'art');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('canvas-design', 'visual');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('imagen', 'Imagen', 'Generate images using Google Gemini''s image generation API for UI mockups, icons, illustrations, and visual assets.', '使用 Google Gemini 图像生成 API 生成 UI 模型、图标、插画与视觉素材。', '## What is Imagen?
...
A: Yes, you can request multiple versions of the same concept.', '## 什么是 Imagen？
...
A: 可以，你可以请求同一概念的多个版本。', 'creative-media', 'https://github.com/sanjay3290/ai-skills/tree/main/skills/imagen', 'sanjay3290', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('imagen', 'images');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('imagen', 'generation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('imagen', 'ai');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('image-enhancer', 'Image Enhancer', 'Improves image and screenshot quality by enhancing resolution, sharpness, and clarity for professional presentations.', '通过提升分辨率、锐度与清晰度改善图片与截图质量，用于专业展示。', '## What is Image Enhancer?
...
A: Yes, particularly effective for UI screenshots and text-heavy images.', '## 什么是 Image Enhancer？
...
A: 有效，特别适用于 UI 截图和文字密集的图像。', 'creative-media', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/image-enhancer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('image-enhancer', 'images');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('image-enhancer', 'enhancement');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('image-enhancer', 'quality');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('slack-gif-creator', 'Slack GIF Creator', 'Creates animated GIFs optimized for Slack with validators for size constraints and composable animation primitives.', '创建适配 Slack 的动画 GIF，提供尺寸限制校验与可组合动画原语。', '## What is Slack GIF Creator?
...
A: Configurable frame rates balanced for quality and file size.', '## 什么是 Slack GIF Creator？
...
A: 可配置的帧率，平衡质量和文件大小。', 'creative-media', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/slack-gif-creator', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('slack-gif-creator', 'gif');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('slack-gif-creator', 'slack');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('slack-gif-creator', 'animation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('theme-factory', 'Theme Factory', 'Applies professional font and color themes to artifacts including slides, docs, reports, and HTML landing pages.', '为作品应用专业字体与配色主题，涵盖幻灯片、文档、报告与 HTML 落地页。', '## What is Theme Factory?
...
A: Yes, provide brand colors and fonts to create matching themes.', '## 什么是 Theme Factory？
...
A: 可以，提供品牌颜色和字体来创建匹配的主题。', 'creative-media', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/theme-factory', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('theme-factory', 'themes');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('theme-factory', 'design');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('theme-factory', 'styling');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('video-downloader', 'Video Downloader', 'Downloads videos from YouTube and other platforms for offline viewing, editing, or archival.', '从 YouTube 等平台下载视频，用于离线观看、编辑或归档。', '## What is Video Downloader?
...
A: Only videos you have access to. Authentication may be required for private content.', '## 什么是 Video Downloader？
...
A: 只能下载你有权访问的视频。私人内容可能需要身份验证。', 'creative-media', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/video-downloader', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('video-downloader', 'video');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('video-downloader', 'download');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('video-downloader', 'youtube');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('youtube-transcript', 'YouTube Transcript', 'Fetch transcripts from YouTube videos and prepare summaries.', '获取 YouTube 视频字幕并生成摘要。', '## What is YouTube Transcript?
...
A: Yes, if the video has transcripts in multiple languages available.', '## 什么是 YouTube Transcript？
...
A: 可以，如果视频有多种语言的字幕可用。', 'creative-media', 'https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/youtube-transcript', 'michalparkola', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('youtube-transcript', 'youtube');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('youtube-transcript', 'transcript');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('youtube-transcript', 'video');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('file-organizer', 'File Organizer', 'Intelligently organizes files and folders by understanding context, finding duplicates, and suggesting better structures.', '通过理解上下文、查找重复项并建议更优结构来智能整理文件与文件夹。', '## What is File Organizer?
...
A: Yes, it can maintain existing structures while optimizing.', '## 什么是 File Organizer？
...
A: 可以，它可以在优化的同时保持现有结构。', 'productivity', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/file-organizer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('file-organizer', 'files');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('file-organizer', 'organization');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('file-organizer', 'automation');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('invoice-organizer', 'Invoice Organizer', 'Automatically organizes invoices and receipts for tax preparation by reading files, extracting information, and renaming consistently.', '通过读取文件、提取信息并统一命名来自动整理发票与收据以便报税。', '## What is Invoice Organizer?
...
A: High accuracy for standard invoice formats. Manual review recommended for unusual formats.', '## 什么是 Invoice Organizer？
...
A: 对标准发票格式准确率高。不常见格式建议手动审查。', 'productivity', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/invoice-organizer', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('invoice-organizer', 'invoices');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('invoice-organizer', 'tax');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('invoice-organizer', 'organization');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('kaizen', 'Kaizen', 'Applies continuous improvement methodology with multiple analytical approaches, based on Japanese Kaizen philosophy.', '基于日本 Kaizen 理念，使用多种分析方法实施持续改进。', '## What is Kaizen?
...
A: Small improvements are immediate. Cumulative benefits grow over time.', '## 什么是 Kaizen？
...
A: 小改进是立竿见影的。累积效益随时间增长。', 'productivity', 'https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen', 'NeoLabHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('kaizen', 'improvement');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('kaizen', 'methodology');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('kaizen', 'lean');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('n8n-skills', 'n8n Skills', 'Enables AI assistants to directly understand and operate n8n workflows.', '让 AI 助手直接理解并操作 n8n 工作流。', '## What is n8n Skills?
...
A: It generates workflow JSON. Importing to your instance is a separate step.', '## 什么是 n8n Skills？
...
A: 它生成工作流 JSON。导入到你的实例是单独的步骤。', 'productivity', 'https://github.com/haunchen/n8n-skills', 'haunchen', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('n8n-skills', 'n8n');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('n8n-skills', 'automation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('n8n-skills', 'workflows');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('raffle-picker', 'Raffle Winner Picker', 'Randomly selects winners from lists, spreadsheets, or Google Sheets for giveaways with cryptographically secure randomness.', '使用加密级随机从列表、表格或 Google Sheets 中抽取抽奖获奖者。', '## What is Raffle Winner Picker?
...
A: Generates audit logs with timestamps and selection methodology.', '## 什么是 Raffle Winner Picker？
...
A: 生成带有时间戳和选择方法的审计日志。', 'productivity', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/raffle-winner-picker', 'ComposioHQ', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('raffle-picker', 'raffle');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('raffle-picker', 'random');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('raffle-picker', 'giveaway');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('resume-generator', 'Tailored Resume Generator', 'Analyzes job descriptions and generates tailored resumes that highlight relevant experience and skills.', '分析岗位描述并生成量身定制的简历，突出相关经验与技能。', '## What is Tailored Resume Generator?
...
A: Yes, it can identify gaps between your experience and job requirements.', '## 什么是 Tailored Resume Generator？
...
A: 可以，它可以识别你的经历与职位要求之间的差距。', 'productivity', 'https://github.com/ComposioHQ/awesome-claude-skills/tree/master/tailored-resume-generator', 'ComposioHQ', 1, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('resume-generator', 'resume');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('resume-generator', 'job');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('resume-generator', 'career');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('ship-learn-next', 'Ship Learn Next', 'Skill to help iterate on what to build or learn next, based on feedback loops.', '基于反馈循环帮助迭代下一步要构建或学习的内容。', '## What is Ship Learn Next?
...
A: Designed for individual learning but principles apply to teams.', '## 什么是 Ship Learn Next？
...
A: 为个人学习设计，但原则也适用于团队。', 'productivity', 'https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/ship-learn-next', 'michalparkola', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ship-learn-next', 'learning');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ship-learn-next', 'iteration');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('ship-learn-next', 'feedback');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('tapestry', 'Tapestry', 'Interlink and summarize related documents into knowledge networks.', '将相关文档互相关联并总结为知识网络。', '## What is Tapestry?
...
A: Yes, new documents can be added to existing knowledge networks.', '## 什么是 Tapestry？
...
A: 可以，可以向现有知识网络添加新文档。', 'productivity', 'https://github.com/michalparkola/tapestry-skills-for-claude-code/tree/main/tapestry', 'michalparkola', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tapestry', 'knowledge');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tapestry', 'documents');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('tapestry', 'linking');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('git-pushing', 'Git Pushing', 'Automate git operations and repository interactions.', '自动化 git 操作与仓库交互。', '## What is Git Pushing?
...
A: Respects branch protection rules and will notify when blocked.', '## 什么是 Git Pushing？
...
A: 尊重分支保护规则，被阻止时会通知。', 'collaboration', 'https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/git-pushing', 'mhattingpete', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-pushing', 'git');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-pushing', 'automation');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('git-pushing', 'workflow');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('review-implementing', 'Review Implementing', 'Evaluate code implementation plans and align with specs.', '评估代码实现计划并与规范对齐。', '## What is Review Implementing?
...
A: Provides guidance on what needs to change, not direct code edits.', '## 什么是 Review Implementing？
...
A: 提供需要更改什么的指导，而不是直接的代码编辑。', 'collaboration', 'https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/review-implementing', 'mhattingpete', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('review-implementing', 'code-review');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('review-implementing', 'planning');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('review-implementing', 'specs');
INSERT OR REPLACE INTO skills (id, name, description, description_zh, content, content_zh, category, repository, author, featured, official) VALUES ('test-fixing', 'Test Fixing', 'Detect failing tests and propose patches or fixes.', '检测失败测试并提出补丁或修复方案。', '## What is Test Fixing?
...
A: Analyzes both possibilities and indicates likely cause.', '## 什么是 Test Fixing？
...
A: 分析两种可能性并指出可能的原因。', 'collaboration', 'https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/test-fixing', 'mhattingpete', 0, 0);
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('test-fixing', 'testing');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('test-fixing', 'debugging');
INSERT OR REPLACE INTO skill_tags (skill_id, tag) VALUES ('test-fixing', 'fixes');
